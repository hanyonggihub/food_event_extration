...
class InputExample(object):
    def __init__(self, guid, text_a, text_b=None, label=None,trigger=None):
...
class InputFeature(object):
    ...
    '''
    def __init__(self,input_ids,input_mask,segment_ids,label_id,input_len,trigger):
...
class BertProcessor(object):
    ...
    def create_examples(self,lines,example_type,cached_examples_file):
        ...
        if cached_examples_file.exists():
            ...
            for i,line in enumerate(lines):
                ...
                text_b = None
                trigger=list(map(int,trigger.split('_')))
                example = InputExample(guid = guid,text_a = text_a,text_b=text_b,label= label,trigger=trigger)
        ...
        if cached_features_file.exists():
            ...
            for ex_id,example in enumerate(examples):
                ...
                if example.text_b:
                    ...
                    self.truncate_seq_pair(tokens_a,tokens_b,trigger,max_length = max_seq_len - 3)
                else:
                ...
                feature = InputFeature(input_ids = input_ids,
                                       ...
                                       label_id = label_id,
                                       input_len = input_len,trigger=trigger)
    ...
    def create_dataset(self,features,is_sorted = False):
        ...
        all_triggers=torch.tensor([f.trigger for f in features],dtype=torch.long)
        all_input_lens = torch.tensor([f.input_len for f in features], dtype=torch.long)
        dataset = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids,all_input_lens,all_triggers)
        return dataset
