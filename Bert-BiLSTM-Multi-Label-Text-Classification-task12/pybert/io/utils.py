...
def collate_fn(batch):
    ...
    """
    all_input_ids, all_input_mask, all_segment_ids, all_label_ids,all_input_lens,all_trigger = map(torch.stack, zip(*batch))
    ...
    return all_input_ids, all_input_mask, all_segment_ids, all_label_ids,all_trigger
