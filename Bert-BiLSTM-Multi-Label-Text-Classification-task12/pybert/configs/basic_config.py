...
config = {
    ...
    # 'bert_vocab_path': BASE_DIR / 'pretrain/robert/base-uncased/vocab.txt',
    # 'bert_config_file': BASE_DIR / 'pretrain/robert/base-uncased/config.json',
    # 'bert_model_dir': BASE_DIR / 'pretrain/robert/base-uncased'
